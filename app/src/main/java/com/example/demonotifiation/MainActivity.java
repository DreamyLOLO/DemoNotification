package com.example.demonotifiation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNotify2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bigText.bigText("This is one big text" + " - A quick brown fox jumps over the lazy brown dog " + "\nLoren ipsum dolor sit amet, sea eu quod des");
